...
- **Admin auth** — SSO via Authelia OIDC (Auth.js); all routes under `/admin` are protected

## Tech stack

- [Next.js 15](https://nextjs.org) (App Router)
- [Prisma 7](https://www.prisma.io) + PostgreSQL
- [Auth.js 5](https://authjs.dev) with Authelia OIDC
...
| `OIDC_ISSUER` | Authelia issuer URL |
